...
const home = (req, res) => {
    ...
    res.render('pages/page', {
        menu: (0, createMenuObject_1.createMenuObjetc)('all'),
        banner: {
...
const dogs = (req, res) => {
    ...
    res.render('pages/page', {
        menu: (0, createMenuObject_1.createMenuObjetc)('dog'),
        banner: {
            title: 'Cachorros',
...
const cats = (req, res) => {
    ...
    res.render('pages/page', {
        menu: (0, createMenuObject_1.createMenuObjetc)('cat'),
        banner: {
            title: 'Gatos',
...
const fishes = (req, res) => {
    ...
    res.render('pages/page', {
        menu: (0, createMenuObject_1.createMenuObjetc)('fish'),
        banner: {
            title: 'Peixes',
